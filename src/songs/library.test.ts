...
describe("initializeFromLibrary", () => {
  it("handles non-existent library dir", () => {
    // Should not throw, just log
    initializeFromLibrary(join(tmp, "no-such-dir"));
  ...
  it("skips ready songs without MIDI", () => {
  ...
  it("loads both library and user songs", () => {
    ...
    initializeFromLibrary(tmp, userDir);
    const songs = getAllSongs();
