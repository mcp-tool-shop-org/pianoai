...
For Claude Code, the same configuration applies. Add it to your MCP server settings and all 49 tools and 4 prompt templates become available in your coding session.
