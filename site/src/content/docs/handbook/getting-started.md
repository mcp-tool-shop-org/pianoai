...
For Claude Code, the same configuration applies. Add it to your MCP server settings and all 46 tools and 3 prompt templates become available in your coding session.
