...
- [x] `[mcp]` Tool errors return structured results — server never crashes on bad input (2026-02-27) — 22 isError returns
...
- [x] `[all]` Version in manifest matches git tag (2026-02-27) — package.json version = "1.3.1"
